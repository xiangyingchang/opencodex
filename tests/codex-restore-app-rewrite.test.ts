...
const CATALOG_REWRITE_RESTORE = [
  ...
  '  fs.writeFileSync(cachePath, JSON.stringify({ models: [{ slug: "gpt-5.5" }, { slug: "opencode-go/deepseek-v4-flash", description: "Routed via opencodex → deepseek-v4-flash" }] }), "utf8");',
  "  await injectCodexConfig(10100, {",
  "    port: 10100,",
  "    providers: {},",
  '    defaultProvider: "openai",',
